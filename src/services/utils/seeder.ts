...
/**
 * Generar insert statements  para la tabla `clase` siguiendo estas
 * asignaciones (año 2023):
 *
 *   docente.id | docente.nombres | asignatura.id | asignatura.nombre
 *         2          docente1            1	           matemáticas
 *         3          docente2            2	           lenguaje
 *         4          docente3            3	           historia
 *         5          docente4            4	           ciencias  naturales
 *         6          docente5            5	           inglés
 *         7          docente6            6	           educación  física
 *         8          docente7            7	           música
 *         9          docente8            8	           artística
 *
